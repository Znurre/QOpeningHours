...
#ifndef QOPENINGHOURS_INTERVAL_H
#define QOPENINGHOURS_INTERVAL_H
...
class QOPENINGHOURS_EXPORT Interval
{
    Q_GADGET
...
public:
     ...
     *  @note This is different from an interval with an open end time.
     */
    bool hasOpenEnd() const;

    /** Returns @c true if this is an interval with an open end time, ie. an interval generated by a selector like "20:00+".
     *  @note This is different from an interval with an open end.
     */
...
Q_DECLARE_METATYPE(QOpeningHours::Interval)

QOPENINGHOURS_EXPORT QDebug operator<<(QDebug debug, const QOpeningHours::Interval &interval);

#endif // QOPENINGHOURS_INTERVAL_H
