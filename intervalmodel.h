...
#ifndef QOPENINGHOURS_INTERVALMODEL_H
#define QOPENINGHOURS_INTERVALMODEL_H
...
class QOPENINGHOURS_EXPORT IntervalModel : public QAbstractListModel
{
    Q_OBJECT
    /** The opening hours expression shown in this model. */
    Q_PROPERTY(QOpeningHours::OpeningHours openingHours READ openingHours WRITE setOpeningHours NOTIFY openingHoursChanged)
...
#endif // QOPENINGHOURS_INTERVALMODEL_H
