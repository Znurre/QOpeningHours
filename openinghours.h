...
#ifndef QOPENINGHOURS_OPENINGHOURS_H
#define QOPENINGHOURS_OPENINGHOURS_H
 ...
 */
class QOPENINGHOURS_EXPORT OpeningHours
{
    Q_GADGET
...
#ifndef QOPENINGHOURS_VALIDATOR_ONLY
    /** Returns the interval containing @p dt. */
    Q_INVOKABLE QOpeningHours::Interval interval(const QDateTime &dt) const;
    /** Returns the interval immediately following @p interval. */
    Q_INVOKABLE QOpeningHours::Interval nextInterval(const QOpeningHours::Interval &interval) const;
#endif
...
Q_DECLARE_METATYPE(QOpeningHours::OpeningHours)

#endif // QOPENINGHOURS_OPENINGHOURS_H
